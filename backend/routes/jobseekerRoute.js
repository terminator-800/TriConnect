...
const { register, verifyEmail, getJobseekerProfile, uploadRequirements, apply } = require("../controllers/jobseekerController");
...
router.post("/jobseeker/applications", apply)
