...
async function createUsersTable(connection : Pool | PoolConnection) {
  const query = `
...
async function createJobseekerTable(connection : Pool | PoolConnection) {
  const query = `
...
async function createBusinessEmployerTable(connection : Pool | PoolConnection) {
  const query = `
...
async function createIndividualEmployerTable(connection : Pool | PoolConnection) {
  const query = `
...
async function createManpowerProviderTable(connection : Pool | PoolConnection) {
  const query = `
...
async function createJobPostTable(connection : Pool | PoolConnection) {
  const query = `
...
async function createJobApplicationsTable(connection : Pool | PoolConnection) {
  const query = `
...
async function conversations(connection : Pool | PoolConnection) {
  const query = `
...
async function messages(connection : Pool | PoolConnection) {
  const query = `
...
async function createReportsTable(connection : Pool | PoolConnection) {
  const query = `
...
async function createReportProofsTable(connection : Pool | PoolConnection) {
  const query = `
...
async function feedback(connection : Pool | PoolConnection) {
  const query = `
