...
async function findExistingReport(connection, reportedBy, reportedUserId) {
...
async function insertNewReport(connection, reportedBy, reportedUserId, reason, message, conversationId) {
...
// Reported Users
async function getReportedUsersBy(connection, reportedBy) {
...
async function moveFilesAndInsertToDB(files, tempPath, finalPath, reportId, connection) {
