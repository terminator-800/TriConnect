    ...
    <div className=''>
      ...
      <section className="text-center">
        <div className="justify-center items-center 
          ...
          <p className="mt-5 text-gray-600 mb-10 text-base sm:text-lg md:text-xl max-w-2xl mx-auto px-2">
            An all-in-one job-matching platform that connects job seekers, employers,
            and manpower providers — designed to simplify your job search and hiring
            process with a clean, easy-to-use experience.
          </p>
      ...
      '>
        ...
        <div className='border-l-10 border-[#003479] xl:pl-5 lg:pl-5 md:pl-5 max-[769px]:pl-5'>
          ...
          <h1 className='font-bold text-3xl'>WE BUILD CONNECTIONS <br /> THAT MATTER</h1>
        </div>
        <p className='mt-15 text-[#666666]'>
          <span className='text-[#003479] font-bold'>TriConnect</span> is built on the mission of bridging the gap between job seekers, employers, and manpower agencies. <br />
          Whether you're looking to hire, find work, or expand your recruitment reach, TriConnect provides a streamlined platform tailored to your needs.
        </p>
        <p className='mt-5 text-[#666666]'>
          From posting jobs to finding the right match — we make the process efficient, reliable, and user-friendly.
        </p>
      </section>
      ...
      <section id='how_it_works' className='mt-30'>
        <h1 className='text-3xl font-bold text-center'>WHY CHOOSE <span className='text-[#003479]'>TriConnect</span> </h1>
        <p className='text-lg text-gray-600 mt-5 text-center'>Our platform offers a comprehensive suite of features designed to streamline  <br />
          the hiring process and improve access to job opportunities for all.</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 mt-2">
                    TriConnect connects job seekers, employers, and manpower agencies in one seamless system —
                    making the hiring and job-finding process faster and more convenient.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col w-full gap-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h1 className="text-lg font-semibold">All-in-One Platform</h1>
                  <p className="text-gray-700 mt-2">
                    Designed with simplicity in mind, TriConnect makes it easy for anyone to post jobs, apply, and connect — even for first-time users.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col w-full gap-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h1 className="text-lg font-semibold">All-in-One Platform</h1>
                  <p className="text-gray-700 mt-2">
                    All users undergo a verification process to ensure safety and trust within the platform.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* STARTER / PREMIUM */}
      <section>
        <div className="flex flex-col rounded-full justify-center items-center text-center
        xl:h-[70vh] 
        lg:h-[70vh] 
        md:h-[70vh] 
        sm:h-[70vh]
        ...
        >
          ...
          '>
            ...
            <div className='w-70 bg-white rounded-lg text-left px-10 py-5 shadow-[4px_4px_10px_rgba(0,0,0,0.15)]'>
              ...
              <button className='mx-auto block rounded-xl bg-[#EFF2F9] text-[#666666] px-15 py-1 mt-5 cursor-pointer shadow-[4px_4px_10px_rgba(0,0,0,0.15)]'>Join Now</button>
            </div>
      ...
      <section className="bg-cyan-100 py-16 px-8 md:px-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 text-center">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <p className="text-[#666666] text-sm leading-relaxed max-w-[220px]">
              Browse jobs, post opportunities, or facilitate connections between employers and job seekers.
            </p>
          </div>
      ...
      <section className='xl:mx-50 lg:mx-15 md:mx-10 sm:mx-10 mb-50'>
        ...
        <div className="bg-white text-center flex flex-col justify-center items-center mt-60 mb-20">
          <h1 className="text-5xl max-[769px]:text-3xl font-bold mb-5 text-[#003479] ">What Our Users Say</h1>
