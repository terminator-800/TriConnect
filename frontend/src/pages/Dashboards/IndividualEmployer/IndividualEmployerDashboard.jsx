...
import FindAgencies from './FindAgencies';
import Message from './Message';

const SIDEBAR_WIDTH = 15;

const IndividualEmployerDashboard = () => {
      ...
      <div className="pt-[80px] pl-60">
        {activeComponent === 'JobPostDetail' ? (
          ...
          <div className="flex flex-col items-center justify-center min-h-screen">
            <h1 className="text-3xl font-bold mb-4 text-center">Individual Employer Dashboard</h1>
