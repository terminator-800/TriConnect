  ...
  return (
    <div
      className={`relative max-w-sm p-3 rounded mb-2 ${
        isOwnMessage ? 'bg-blue-200 ml-auto text-right' : 'bg-gray-200 text-left'
      }`}
    >
      ...
      <div className="text-xs text-gray-600 mt-1 flex justify-between items-center">
        ...
        {/* ✅ Only show seen indicator if it's the last message by current user AND it's marked as read */}
