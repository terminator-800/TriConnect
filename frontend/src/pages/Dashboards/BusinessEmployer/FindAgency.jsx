...
const FindAgency = () => {
  ...
  return (
     ...
     <div className="relative min-h-[140vh]  bg-gradient-to-b from-white to-cyan-400 pl-110 pr-50 pt-50">
      ...
      <h1 className="text-5xl font-bold text-blue-900">Search for Manpower Provider</h1>
      <p className="text-2xl mt-2">Find agencies to help with your recruitment needs</p>
