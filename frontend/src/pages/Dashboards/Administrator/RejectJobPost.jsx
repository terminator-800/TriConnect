...
const RejectJobPost = ({ jobPost, users, onClose, onRejected }) => {
    ...
    const handleReject = async () => {
        ...
        try {
            ...
            alert("Job post reject successfully.")
            onRejected();
        } catch (error) {
    ...
    return (
        <div className="fixed inset-0 bg-opacity-50 z-50 flex items-center justify-center">
            <div className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full relative border border-gray-300">
                ...
                <p className='text-gray-700 text-center mb-4'>Are you sure you want to reject this jobpost? This action cannot be undone.</p>
