...
const ApprovedJobPost = ({ jobPost, onApproved, onClose }) => {
  useEffect(() => {
  ...
  const approveMutation = useMutation({
    mutationFn: async () => {
      const response = await axios.patch(
        `${import.meta.env.VITE_API_URL}/${ROLE.ADMINISTRATOR}/approve/jobpost/${jobPost.job_post_id}`,
        {},
    ...
    <div className="fixed inset-0 bg-opacity-50 z-50 flex items-center justify-center">
      <div className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full relative border border-gray-300">
        ...
        <div className="border border-gray-300 p-5 rounded-xl text-gray-600 mb-4">
          ...
          {/* Use jobPost directly for "Posted by" */}
