...
import ManpowerProviderFindJob from '../ManpowerProvider/ManpowerProviderFindJob';
import ManpowerProviderCreateJobPost from '../ManpowerProvider/ManpowerProviderCreateJobPost';
import Feedback from '../Feedback';
import ManpowerProviderMessage from './ManpowerProviderMessage';
 ...
 <div className="relative min-h-screen bg-gradient-to-b from-white to-cyan-400">
      ...
      <div>
        {activeComponent === 'ManpowerProviderFindJob' ? (
          ...
          <ManpowerProviderCreateJobPost />
        ) : activeComponent === 'ManpowerProviderMessage' ? (
          <ManpowerProviderMessage />
        ) : (
          <div className="flex flex-col items-center justify-center min-h-screen">
            <h1 className="text-3xl font-bold mb-4 text-center">Manpower Provider Dashboard</h1>
